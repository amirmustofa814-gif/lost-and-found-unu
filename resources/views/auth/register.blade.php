<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        {{-- 2. NIM / Identitas --}}
        <div class="mt-4">
            <x-input-label for="nim" :value="__('NIM / Nomor Identitas')" />
        ...
        <div class="mt-4" x-data="{ show: false }">
            ...
            <div class="relative">
                ...
                <button type="button" @click="show = !show" 
                        class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 hover:text-gray-700 focus:outline-none cursor-pointer">
        ...
        {{-- 5. Konfirmasi Password (Dengan Mata 👁️) --}}
        <div class="mt-4" x-data="{ show: false }">
